...
junit allowEmptyResults: true, testResults: '**/target/surefire-reports/*.xml', testDataPublishers: [[$class: 'JiraTestDataPublisher', projectKey: 'PTP', issueType: 'Bug', autoRaiseIssue: true, autoResolveIssue: false, autoUnlinkIssue: true, configs: [[$class: 'SelectableFields', [[fieldKey:"summary", value: ${DEFAULT_SUMMARY]], [[$class: 'SelectableFields', [[fieldKey:"description", value: ${DEFAULT_DESCRIPTION]] ]] ]]
